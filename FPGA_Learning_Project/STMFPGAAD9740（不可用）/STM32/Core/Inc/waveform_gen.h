...
/**
 * @brief  Generate custom/arbitrary waveform from user-provided data
 * @param  buf         Output buffer (caller-allocated)
 * @param  points      Number of samples to write
 * @param  custom_data Pointer to source data array
 * @param  data_len    Length of source data in samples
 * @note   If data_len < points, remaining samples are filled with DAC_MID_VALUE
 * @return Number of samples written (== points)
 */
