...
{
    HAL_ADCEx_Calibration_Start(myhadc->hadc,ADC_CALIB_OFFSET,ADC_SINGLE_ENDED);
...
{
    HAL_ADCEx_Calibration_Start(myhadc->hadc_master,ADC_CALIB_OFFSET ,ADC_SINGLE_ENDED);
    HAL_ADCEx_Calibration_Start(myhadc->hadc_slave,ADC_CALIB_OFFSET,ADC_SINGLE_ENDED);
...
{
    HAL_ADCEx_MultiModeStop_DMA(myhadc->hadc_master);
    HAL_TIM_Base_Stop(myhadc->htim);
}
/* USER CODE END 1 */
